...
public class PredicadosOperaciones {
    ...
    public String Process(String instrucc){
        ...
        //Cuando la operaci�n es del tipo Atom
        if(atom==true){
        ...
        //Cuando la operaci�n es del tipo Equal
        if(equal==true){
            String[] SaltoEspacio=expsplit.split(" ");
            if(SaltoEspacio.length<=2){
        ...
        //Cuando la operaci�n es del tipo list
        if(list==true){
        ...
        //Cuando la operaci�n es mayor que
        if(mayorQue==true){
            String[] SaltoEspacio=expsplit.split(" ");
            if(SaltoEspacio.length<=2){
                System.out.println("No hay suficientes parametros");
        ...
        //Cuando la operaci�n es menor que
        if(menorQue==true){
            String[] SaltoEspacio=expsplit.split(" ");
            if(SaltoEspacio.length<=2){
                System.out.println("No es un dato numerico");
